...
router.route('/forgotpassword').post(forgotPassword); // PUT /api/v1/auth/forgotpassword
...
router.route('/update-details').put(protect, updateUserDetails); // PUT /api/v1/auth/update-details
router.route('/update-password').put(protect, updateUserPassord); // PUT /api/v1/auth/update-password
